...
m1 <- 'gHick =~ H0meanRT100 + H1meanRT100 + H2meanRT100
...
# .... 1.2 Hick und g ----------------------------------
m2 <- 'gHick =~ H0meanRT100 + H1meanRT100 + H2meanRT100
...
m4 <- 'gHick =~ H0meanRT100 + H1meanRT100 + H2meanRT100 
      gSupp2 =~ S1mean100 + S2mean100 + S3mean100 + S4mean100
...
m9 <- 'gHick =~ H0meanRT100 + H1meanRT100 + H2meanRT100
      gSupp2 =~ S1mean100 + S2mean100 + S3mean100 + S4mean100
...
m5 <- '  CH =~ 1*H0meanRT100 + 1*H1meanRT100 + 1*H2meanRT100 
       expH =~ 1*H0meanRT100 + 2*H1meanRT100 + 4*H2meanRT100
...
# .... 2.2 Hick und g ----------------------------------
m6 <- '  C =~ 1*H0meanRT100 + 1*H1meanRT100 + 1*H2meanRT100
       exp =~ 1*H0meanRT100 + 2*H1meanRT100 + 4*H2meanRT100
         g =~ zSpeed + zCapacity + zMemory
         g ~ C + exp
         C ~~ 0*exp'
...
m8 <- '  CH =~ 1*H0meanRT100 + 1*H1meanRT100 + 1*H2meanRT100
       expH =~ 1*H0meanRT100 + 2*H1meanRT100 + 4*H2meanRT100 
