# ---
# Title: "spatial_suppression_rmse_density.R"
# Description: "This code reproduces the density function of the spatial
# suppression RMSE"
...
rmse.density <- density(dat$Srmse, bw=.7)
plot(rmse.density,
     main = "",
     xlim = c(0,70),
     ylim = c(0,.15),
...
rug(dat$Srmse, ticksize = .1)

# ==============================================================================
# Generate .tex file -----------------------------------------------------------
tikz(file = "../Arbeit/PhD_thesis/tikzDevice/spatial_suppression_rmse_density.tex",
     width = 5,
     height = 2)
plot.new()
