# ---
# Title: "6_hick_linmodel"
# Description: "This code produces a line graph of the linear model used to
#               explain the hick data"
...
x <- seq(-1,10,.01)
y <- mean(dat$Hinter) + (mean(dat$Hslope)*x)
